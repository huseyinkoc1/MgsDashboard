...
import kotlinx.android.synthetic.main.recyler_redmine_first.view.textViewName
import kotlinx.android.synthetic.main.recyler_redmine_first.view.textViewRank
import kotlinx.android.synthetic.main.recyler_redmine_second.view.*

class AdapterTaskCompletedSecond (private val pointList:Array<TaskCompleted>) : RecyclerView.Adapter<AdapterTaskCompletedSecond.RowHolder>() {
