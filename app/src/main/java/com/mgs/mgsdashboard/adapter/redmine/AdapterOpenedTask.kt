...
class AdapterOpenedTask(private val pointList:Array<TaskCreated>) : RecyclerView.Adapter<AdapterOpenedTask.RowHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RowHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recyler_redmine_first,parent,false)
